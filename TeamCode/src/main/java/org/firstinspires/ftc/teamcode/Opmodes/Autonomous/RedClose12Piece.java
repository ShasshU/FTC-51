...
@Configurable
@Autonomous(name = "Red Close 12 Piece", group = "Autonomous")
public class RedClose12Piece extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            GateSetup = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(131.189, 82.882), new Pose(114, 73)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(180))
                    .build();

            GateEmpty = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(114, 73), new Pose(130, 73)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            ScorePickup1 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(130, 73), new Pose(84.1, 83.882)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(40.5))
                    .build();
            ...
            Pickup3Part1 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(84.085, 83.882), new Pose(84, 34.5)))
                    .setLinearHeadingInterpolation(Math.toRadians(42.5), Math.toRadians(0))
                    .build();

            Pickup3Part2 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(84, 34.5), new Pose(140, 34.5)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();

            ScorePickup3 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(132, 34.5), new Pose(84.085, 83.882)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(42.5))
                    .build();
