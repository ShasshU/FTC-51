...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2462.701390576203; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2277.055499071576; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2292.4241384245543; // x position of the perpendicular encoder (in tick units)
    }
