...
@Configurable
@Autonomous(name = "Red Close 12 Piece No Gate", group = "Autonomous")
public class RedClose12PieceNG extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            ScorePickup3 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(140, 34.5), new Pose(84.085, 83.882)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(42.5))
                    .build();
