...
public class Intake {
    ...
    private static final double FAST_POWER = 1.0;
    ...
    public void toggleIntakeFast() {
        if (currentState == IntakeState.FAST) {
            stop();
        } else {
            startIntakeFast();
        }
    ...
    public void startIntakeFast() {
        currentState = IntakeState.FAST;
        intake.setPower(FAST_POWER);
    }
