...
public class RedClose9Piece extends OpMode {
    ...
    private final Pose bluePickup1IntermediatePose = new Pose(41.027, 83.678, Math.toRadians(180));
    private final Pose bluePickup1Pose = new Pose(13.811, 83.882, Math.toRadians(180));
    private final Pose bluePickup2IntermediatePose = new Pose(60.000, 60.500, Math.toRadians(180));
    private final Pose bluePickup2Pose = new Pose(14.827, 60.118, Math.toRadians(180));
    ...
    private final Pose pickup1IntermediatePose = bluePickup1IntermediatePose.mirror();
    private final Pose pickup1Pose = bluePickup1Pose.mirror();
    private final Pose pickup2IntermediatePose = bluePickup2IntermediatePose.mirror();
