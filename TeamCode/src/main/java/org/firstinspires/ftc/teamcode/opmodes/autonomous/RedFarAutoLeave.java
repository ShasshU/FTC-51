...
@Autonomous()
public class RedFarAutoLeave extends LinearOpMode {
    ...
    public class threeBallLaunch implements InstantFunction {
        @Override
        public void run() {
          Kicker.setServoPos1(0.9);
          sleep(1000);
          Kicker.setServoPos1(0.4);
        }
    }
