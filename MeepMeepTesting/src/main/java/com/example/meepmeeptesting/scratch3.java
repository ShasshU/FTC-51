...
public class scratch3 {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(startPos)
                ...
                .lineToY(30)
                .splineTo(new Vector2d(-15, 15), Math.toRadians(135))
                .splineToLinearHeading(new Pose2d(11, 25, Math.toRadians(90)), Math.toRadians(270))
                .lineToY(51)
                .lineToY(30)
                .splineTo(new Vector2d(-15, 15), Math.toRadians(135))
                .splineToLinearHeading(new Pose2d(35, 20, Math.toRadians(90)), Math.toRadians(270))
                .lineToY(51)
                .lineToY(30)
                .splineTo(new Vector2d(-15, 15), Math.toRadians(135))
