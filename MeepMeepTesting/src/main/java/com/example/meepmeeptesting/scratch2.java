...
public class scratch2 {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(startPos)
                ...
                .splineToLinearHeading(new Pose2d(11,-34, Math.toRadians(270)), Math.toRadians(270))
                .lineToY(-51)
                .lineToY(-25)
                .splineTo(new Vector2d(-15,-15), Math.toRadians(225))
                ...
                .lineToY(-25)
                .splineTo(new Vector2d(-15,-15), Math.toRadians(225))
                .splineToLinearHeading(new Pose2d(35,-34, Math.toRadians(270)), Math.toRadians(270))
                .lineToY(-51)
                .lineToY(-25)
                .splineTo(new Vector2d(-15,-15), Math.toRadians(225))
